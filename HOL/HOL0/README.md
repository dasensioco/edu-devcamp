...
1. From the results select `Visual Studio Community 2017 (latest preview) on Windows Server 2016 (x64)` (if the `latest preview` image is not available select `latest release` instead) and click `Create` at the bottom of the page.
